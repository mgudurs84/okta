...
const Messages = () => {
  ...
  useEffect(() => {
    if (authState.isAuthenticated) {
      ...
      authService.getTokenManager().on('expired', function (key, expiredToken) {
        console.log('Token with key', key, ' has expired:');
        console.log(expiredToken);

        authService.getTokenManager().get('accessToken')
        .then(function(token) {
          console.log('new token',token);
          if (token && !authService.getTokenManager().hasExpired(token)) {
            // Token is valid
        ...
        // authService.getTokenManager().renew(expiredToken)
      ...
      // if(authService.getAuthState().accessToken==="undefined"){
       
      //   authService.getTokenManager().renew('accessToken')
      //   .then(function (newToken) {
      //     console.log("token renewed:");  
      //     console.log(newToken);
      //   });
      ...
      async function getToken() {
       ...
       let token = await authService.getTokenManager().get('accessToken');
      ...
      console.log(authService.getTokenManager().get('accessToken'));
    }
